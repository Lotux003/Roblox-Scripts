...
-- Create Window
local lib = Library.CreateWindow("Xotux - Fisch", 6105620301)

-- Create Tabs
local tab1 = lib:Tab("GUIS", 6087485864)
--local tab2 = lib:Tab("tab2")

-- Create tab1 section1
local section1 = tab1:Section("Other Fisch Exploits")
...
-- Create tab1 section2
local section1 = tab1:Section("Universal Exploits")
